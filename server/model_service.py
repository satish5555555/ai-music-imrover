...
# ===============================================================
# Utility: load and normalize audio
# ===============================================================
def load_audio(file_path, target_sr=16000, max_len=5.0):
...
# TRAINING FUNCTION
# ===============================================================
def train_model(data_dir="/app/server/uploads", mode="music", epochs=5, lr=1e-4, target_sr=16000):
...
# INFERENCE FUNCTION
# ===============================================================
def improve_music_or_audio(input_path, output_path, mode="auto", target_sr=16000):
    ...
    waveform, sr = load_audio(input_path, target_sr)
    with torch.no_grad():
